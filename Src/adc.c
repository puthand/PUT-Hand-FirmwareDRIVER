...
void ADC_CUR_POS()
{
	...
	if(ADC_Pos_Count == 2)
		LL_ADC_REG_SetSequencerChannels(ADC1, LL_ADC_CHANNEL_4 | LL_ADC_CHANNEL_7 | LL_ADC_CHANNEL_2);
	else if(ADC_Pos_Count == 3)
		LL_ADC_REG_SetSequencerChannels(ADC1, LL_ADC_CHANNEL_4 | LL_ADC_CHANNEL_7 | LL_ADC_CHANNEL_2 | LL_ADC_CHANNEL_3);
	else if(ADC_Pos_Count == 4)
		LL_ADC_REG_SetSequencerChannels(ADC1, LL_ADC_CHANNEL_4 | LL_ADC_CHANNEL_7 | LL_ADC_CHANNEL_2 | LL_ADC_CHANNEL_3 | LL_ADC_CHANNEL_5);
	else
